...
describe('DetalhamentoItem', function () {
    ...
    describe('::parse()', function () {
        test('Should succeed with dataset :dataset', function ($candidate) {
            ...
            expect($sutResponse->getData())->toBeInstanceOf(DetalhamentoItem::class);
        ...
        })->with(datasets('dfes.nfe.element_tags.' . DetalhamentoItem::FIELD_NAME . '.invalid'));
    });
});
