...
final class ValorUnitarioComercial extends DFeElement implements HasValue
{
    public static string $tagName = 'vUnCom';
    ...
    public static function validateTagValue(string $tagValue): Result
    {
        $validationService = new ValidationService([
            new IsStringValidator(self::$tagName),
            new NotNullValidator(self::$tagName),
            new IsDecimalValidator(self::$tagName, 11, 10),
            new MaxValueValidator(self::$tagName, 99999999999.9999999999),
            new MinValueValidator(self::$tagName, 0.0000000001),
        ]);
