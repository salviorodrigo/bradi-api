...
use BradiNfeApi\Domain\Invoices\NFe\Exceptions\InvalidIndOrigemError;

final class IsTipoOrigemMercadoriaValidator extends Validator
{
    ...
    public function validate(mixed $candidate): Result
    {
        if (! (bool) TipoOrigemMercadoria::tryFrom($candidate)) {
            return Result::makeFailure(new InvalidIndOrigemError(
                $this->fieldURI,
                $this->source,
                $candidate
            ));
