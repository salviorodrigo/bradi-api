...
use BradiApi\Domain\Invoices\Enums\TipoEmissaoNotaFiscal;
use InvalidArgumentException;

final class IsTipoEmissaoNotaFiscalValidator implements Validator
{
    public function check(mixed $candidate): Result
    {
        if (! (bool) TipoEmissaoNotaFiscal::tryFrom($candidate)) {
