...
final class InvalidTypeError extends UnprocessableEntityError
{
    public function __construct(string $field, string $source, mixed $input, string $expectedType)
    {
        $message = "should be of type {$expectedType}.";
        $error = new Error(
            $source,
